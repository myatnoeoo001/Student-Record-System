...
class UpdateMark:
    ...
    def __init__(self, root):
        ...
        self.txtMyanmar = Entry(self.MainFrame, font=('Arial', 14, 'bold'), textvariable=self.Myanmar, width=28)
        ...
        self.txtEnglish = Entry(self.MainFrame, font=('Arial', 14, 'bold'), textvariable=self.English, width=28)
        ...
        self.txtMath = Entry(self.MainFrame, font=('Arial', 14, 'bold'), textvariable=self.Math, width=28)
        ...
        self.txtPhysics = Entry(self.MainFrame, font=('Arial', 14, 'bold'), textvariable=self.Physics, width=28)
        ...
        self.txtChemistry = Entry(self.MainFrame, font=('Arial', 14, 'bold'), textvariable=self.Chemistry, width=28)
        ...
        self.txtBiology = Entry(self.MainFrame, font=('Arial', 14, 'bold'), textvariable=self.Biology, width=28)
