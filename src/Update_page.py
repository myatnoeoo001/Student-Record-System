...
class UpdateStudent:
    ...
    def __init__(self, root):
        ...
        self.txtroll = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.RollNo, width=28)
        ...
        self.txtName = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.StudentName, width=28)
        self.txtName.grid(row=5, column=1)

        #row 3
        self.lblGender = Label(self.MainFrame, font=('Arial',14,'bold'), text='gender', padx=2)
        ...
        self.txtYear = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.Year, width=28)
        ...
        self.txtGrade = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.Grade, width=28)
        ...
        self.txtDob = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.Dob, width=28)
        ...
        self.txtNRC = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.NRC, width=28)
        ...
        self.txtFatherName = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.FatherName, width=28)
        self.txtFatherName.grid(row=11, column=1)

        #row 9
        self.lblAddress = Label(self.MainFrame, font=('Arial',14,'bold'), text='Address', padx=2, pady=2)
        self.lblAddress.grid(row=12, column=0, sticky='w')
        self.txtAddress = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.Address, width=28)
        ...
        self.txtPhone = Entry(self.MainFrame, font=('Arial',14,'bold'), textvariable=self.PhoneNo, width=28)
        ...
        self.btnUpdate = Button(self.MainFrame, text='Update Student', font=('Arial',12,'bold'), height=1, width=16, bd=2, padx=13, command=self.update_student)
